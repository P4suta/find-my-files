...
## [0.2.0](https://github.com/P4suta/find-my-files/compare/v0.1.1...v0.2.0) (2026-09-25)
...
* **ci:** make `just mutants` run the program the CI shard runs ([#204](https://github.com/P4suta/find-my-files/issues/204)) ([69bb9a1](https://github.com/P4suta/find-my-files/commit/69bb9a1c04523adb8192cd6097a55f26f36df532))
* **ci:** make the mutation and SBOM gates judge the reviewed policy ([#196](https://github.com/P4suta/find-my-files/issues/196)) ([8c3c8ea](https://github.com/P4suta/find-my-files/commit/8c3c8ea7f1e57a9f1efa0f750f51bbc547e7c143))
...
* **contract:** let the drift check find the real tree, and say so when it cannot ([#209](https://github.com/P4suta/find-my-files/issues/209)) ([bbb4916](https://github.com/P4suta/find-my-files/commit/bbb4916740324ff2e71b064106774dc8a31fa989))
...
* **deps:** bump the pinned .NET SDK to 10.0.401 for the shipped-runtime CVEs ([#198](https://github.com/P4suta/find-my-files/issues/198)) ([94671c0](https://github.com/P4suta/find-my-files/commit/94671c087dc936778c6dfd9b9fb43e02bcf0bcd4))
* **diag:** make the diagnostics that already exist actually reach someone ([#203](https://github.com/P4suta/find-my-files/issues/203)) ([95b1baa](https://github.com/P4suta/find-my-files/commit/95b1baae036566b2ec7e282c457126fd96cae3b7))
...
* **perf:** make the performance gate one a run can actually meet ([#208](https://github.com/P4suta/find-my-files/issues/208)) ([ca22b41](https://github.com/P4suta/find-my-files/commit/ca22b4111a99f5f59306850331ab348d988e0238))
...
* run the doc gate before the push, not only in CI ([#205](https://github.com/P4suta/find-my-files/issues/205)) ([48ab806](https://github.com/P4suta/find-my-files/commit/48ab806d23c9229820fc8bea0bdd7e47c87f58e4))
...
* **xtask:** stop the observability guard reading other checkouts ([#206](https://github.com/P4suta/find-my-files/issues/206)) ([86785a2](https://github.com/P4suta/find-my-files/commit/86785a208feaa673c023bc583c94038fb7dbff9d))
