...
//   regenerate with `just contract-gen`; `just test` fails
...
internal static class EngineContract
{
    ...
    public const string PipeNameShort = "fmf-engine-v4";
    ...
    public const string ServiceProtocolMarker = "find-my-files filename index engine; protocol=4; pipe=fmf-engine-v4";
    ...
    public static class Op
    {
        ...
        public const ushort QueryCancel = 13;
    }
    ...
    public const int MaxPageRows = 64;
    public const int MaxVolumes = 26;
    public const int MaxQueryBytes = 4096;
    public const int MaxQueryGroups = 32;
    public const int MaxQueryTerms = 128;
    public const int MaxRegexTerms = 8;
    public const int MaxIndexStartPayloadLen = 512;
    ...
    public static class RowOffsets
    {
        ...
        public const int ParentPathLen = 48;
        public const int Reserved = 52;
    }

    public const int EventSize = 32;
    public const int QueryOptionsSize = 32;
    public const int VolumeStatusSize = 32;
    public const int PageStructSize = 40;
...
internal static partial class NativeEngine
{
    ...
    internal struct FmfQueryOptions
    {
        ...
        [FieldOffset(24)] public ulong PresentationBasis;
    }
    ...
    internal struct FmfRow
    {
        ...
        [FieldOffset(44)] public uint NameLen;
        [FieldOffset(48)] public uint ParentPathLen;
        [FieldOffset(52)] public uint Reserved;
    }
    ...
    internal struct FmfPage
    {
        ...
        [FieldOffset(32)] public ulong OwnerId;
    }
    ...
    internal struct FmfBlob
    {
        ...
        [FieldOffset(16)] public ulong OwnerId;
    }
}
