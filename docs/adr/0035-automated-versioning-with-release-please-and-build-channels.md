...
- Release automation is split across the version bot and the release workflow it
  dispatches. **Amended by [ADR-0048](0048-direct-dispatch-release-workflow.md)
  ...
  `just perf-gate`.** No job both executes self-hosted repository code and holds
