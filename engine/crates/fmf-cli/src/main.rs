...
//!
//! This file is the clap surface and dispatch only; command implementations
//! live in `cmd/` (and `bench_support` for the bench-shared pieces). All
//! engine logic stays in fmf-core.
